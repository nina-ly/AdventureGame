...
//            R.layout.throwswordtocuttherope, R.layout.jump, R.layout.changeorientation, R.layout.walkacross, R.layout.opendoor, R.layout.usekey, R.layout.picklock, R.layout.cavewithbreeze};
    ...
    public void onClick(View view){
        ...
        if(progress == R.layout.ogrecave || progress == R.layout.sneakaround || progress == R.layout.keepattacking || progress == R.layout.keepsneaking || progress == R.layout.attackogrewithoutsword || progress ==R.layout.attackogrewithsword)
            checkIfItsNight();
        else
            setContentView(progress);
    }
